<?php 
//enable cores
header('Access-Control-Allow-Origin: http://localhost:8080'); // allow request from the requesting origin 
...
$app->post('/api/player/add', function(Request $request, Response $response){
	...
	//SQL query
    $sql= "INSERT INTO players (name,age,city,province,country) VALUES (:name,:age,:city,:province,:country)";
